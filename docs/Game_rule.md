...
>
> **Xem thêm:** File `exploding_kittens_editions.md` — tổng hợp các Edition khác (2-Player, Party Pack, NSFW...) và Expansion (Imploding/Streaking/Barking Kittens).
...
## 9. Các Edition & Expansion khác

Chi tiết đầy đủ về số lượng bài, luật riêng, và cách thiết lập của từng Edition (2-Player, Party Pack, NSFW, themed editions) và Expansion (Imploding Kittens, Streaking Kittens, Barking Kittens) được trình bày trong file riêng:  **`exploding_kittens_editions.md`** .

Tóm tắt nhanh:

| Tên              | Loại     | Nội dung chính                                                                                        |
| ----------------- | --------- | ------------------------------------------------------------------------------------------------------- |
| Original Edition  | Edition   | Bản chuẩn — 2-5 người, 56 lá (file này)                                                          |
| 2-Player Edition  | Edition   | Bộ rút gọn 32 lá, chỉ 2 người                                                                    |
| Party Pack        | Edition   | 2-10 người, 120 lá, thêm 4 lá hành động mới                                                    |
| NSFW Edition      | Edition   | Giống Original, hình minh họa 17+                                                                    |
| Imploding Kittens | Expansion | Thêm lá Imploding Kitten (2 lần rút mới nổ, không Defuse/Nope được), mở rộng lên 6 người |
| Streaking Kittens | Expansion | Lá Streaking Kitten giúp giữ Exploding Kitten trên tay mà không bị loại                         |
| Barking Kittens   | Expansion | Cơ chế "Stash" + Tower of Power Crown bảo vệ bài khỏi bị lấy trộm                              |
