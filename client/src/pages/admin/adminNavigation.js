export const ADMIN_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'wagers', permission: 'wagers.read', icon: 'savings', vi: ['Cược', 'Ledger và hoàn tiền'], en: ['Wagers', 'Ledger and refunds'] },
  ...
  },
  {
    ...
    en: 'Operate',
    items: [
      { id: 'players', permission: 'players.read', icon: 'group', vi: ['Người chơi', 'Tài khoản và ví Coin'], en: ['Players', 'Accounts and Coin wallet'] },
